...
public class Registration extends javax.swing.JFrame {
    ...
    public Registration() {
        initComponents();
    this.setTitle("Front Desk Clerk");}
        
    public String id=null;
    public Registration(String id2) {
        initComponents();
        id = id2;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        RegistrationData rgData = new RegistrationData();
        jDesktopPane1.add(rgData).setVisible(true);
        try {
            rgData.setMaximum(true);
